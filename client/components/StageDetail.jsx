...
//         });
    ...
    render() {
        ...
        return (
            <div>
                 <div>
                      <a href="/plan.html" style={{margin: "10px"}}  className="btn btn-primary btn-xs">Live Plan</a>
                      <a href="/stage.html" style={{margin: "10px"}} className="btn btn-primary btn-xs">Stage Performance</a>
                    </div>
                 <ul class="pagination">
